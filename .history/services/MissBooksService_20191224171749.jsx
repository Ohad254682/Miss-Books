...
function getListOfGoogleBooks(searchTerm) {
    ...
    var gGoogleBooks = getGoogleBooks().data
        .then( resultsGoogleBooks=gGoogleBooks.items.filter(googleBook=>googleBook.volumeInfo.title.includes(searchTerm))
            forEach(googleBook => {
            resultsGoogleBooks = { title: googleBook.volumeInfo.title, id: googleBook.id }
