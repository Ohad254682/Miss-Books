...
function getListOfGoogleBooks() {
    var listTitlesGoogleBooks;
    var gGoogleBooks = getGoogleBooks().data
        .then(gGoogleBooks.forEach(googleBook => {
            listTitlesGoogleBooks = { title: googleBook.volumeInfo.title, id: googleBook.id }
            return listTitlesGoogleBooks;
        }
